...
--        Crew = 2,
	...
	Pylons =     {
        ...
        pylon(1, 0, 0.00, 0.00, 0.0000,{use_full_connector_position = false, connector = "Pylon_1",
		      FiX = 0, FiY = 0, FiZ = 5},
            {
				{
					CLSID = "DIS_mk46torp",
					connector = "Pylon_1",
					attach_point_position = {-0.3, -0.07, 0}
				}
            }
        ),
        pylon(2, 0, -2.605000, -0.3800, 1.5800,{use_full_connector_position = false, connector = "Pylon_2"},
            {
				--{ CLSID = "{3C612111-C7AD-476E-8A8E-2485812F4E5C}" }, --FAB-250/Depth Charge
            }
        ),
		...
		pylon(4, 0, 0.00, 0.00, 0.0000,{use_full_connector_position = false, connector = "Pylon_4",
			  FiX = 0, FiY = 0, FiZ = 5},
            {
				{ CLSID = "DIS_mk46torp" , connector = "Pylon_4", attach_point_position = {-0.3, -0.07, 0}},
				--{ CLSID = "{3C612111-C7AD-476E-8A8E-2485812F4E5C}" }, --FAB-250/Depth Charge
				--{ CLSID = "{FAB-250-M54-TU}",connector = "Pylon_4"}, --FAB250TU/Torpedo
            }
        ),
		pylon(5, 0, -4.005000, -0.38, 0.0000,{use_full_connector_position = false, connector = "Pylon_5"},
            {
